        ...
        fields: [
          ...
          },
          {
            ...
            value: function(state, item){
              ...
              return "<a target='_blank' href='https://li.phila.gov/Property-History/search/Permit-Detail?address="+encodeURIComponent(item.address)+"&Id="+item.permitnumber+"'>"+item.permitnumber+" <i class='fa fa-arrow-up-right-from-square'></i></a>";
            },
          },
          {
            label: 'Description',
        ...
        fields: [
          ...
          },
          {
            ...
            value: function(state, item){
              ...
              return "<a target='_blank' href='https://li.phila.gov/Property-History/search/Violation-Detail?address="+encodeURIComponent(address)+"&Id="+item.casenumber+"'>"+item.casenumber+" <i class='fa fa-arrow-up-right-from-square'></i></a>";
            },
          },
          {
            label: 'Description',
        ...
        fields: [
          ...
          },
          {
            ...
            value: function(state, item){
              ...
              return "<a target='_blank' href='https://li.phila.gov/Property-History/search/Business-License-Detail?address="+encodeURIComponent(address)+"&Id="+item.licensenum+"'>"+item.licensenum+" <i class='fa fa-arrow-up-right-from-square'></i></a>";
              // return "<a target='_blank' href='http://li.phila.gov/#details?entity=licenses&eid="+item.licensenum+"&key="+encodeURIComponent(item.street_address)+"&address="+encodeURIComponent(item.street_address)+"'>"+item.licensenum+" <i class='fa fa-arrow-up-right-from-square'></i></a>";
