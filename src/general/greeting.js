export default {
  // <p class="small-text">Due to high Election Day traffic, the "Licenses & Inspections" and "Nearby" topics have been temporarily removed. Please check back on November 9th for this information. We apologize for any inconvenience this may cause.</p>\
  message: '\
